...
test wf with "test w1/test w2/donor douse/out/test w3/sank sing/s/test w4/wee wold/n/test w5/a gnome/e/test w6/test w7".
...
test w7 with "weakie way/creaky cray/grit grins/slick sleet".
